// Generated on 2014-01-25 using generator-jade 0.5.4
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      options: {
        compress: true,
        paths: ['<%= folders.app %>/styles', "<%= folders.app %>/bower_components"]
      },
      dist: {
        files: {
          '<%= folders.dist %>/styles/main.css': ['<%= folders.app %>/styles/main.less']
        }
      },
      server: {
        files: {
